...
const MovieForm = (props) => {
    ...
    } = useDropdown(listValidator, initialGenreList, 1, genreLimit);
    ...
    } = useDropdown(listValidator, initialLanguageList, 1, languageLimit);
    ...
    } = useDropdown(listValidator, initialCertificateList, 1, certificateLimit);
    ...
    const formSubmitHandler = (event) => {
        ...
        formData.append('poster', imageValue);
            ...
            <div className={styles['movie-form-container']} >
                ...
                >
                    ...
                    <div className={styles['movie-form-header']} >
                        New Movie<MdOutlineMovieFilter className={styles['new-movie-icon']} />
                    </div>
