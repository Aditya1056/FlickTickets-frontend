...
import styles from './TheatreEditForm.module.css';
...
const TheatreEditForm = (props) => {
    ...
    } = useInput(inputValidator, 1, {value: props.name, isTouched:true});
    ...
    } = useInput(inputValidator, 1, {value: props.address, isTouched:true});
    ...
    } = useInput(phoneValidator, 10, {value: props.phone, isTouched:true});
...
export default TheatreEditForm;